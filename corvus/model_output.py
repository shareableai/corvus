...
def models_to_table(models: Iterable[PyModelSearchResult]) -> None:
    ...
    table.add_column("Short Artefact Schema ID", overflow="ignore")
    table.add_column("Repository")
    table.add_column("Branch")
    table.add_column("Short VCS")
